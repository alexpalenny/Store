...
using SeaStore.Services;
using SeaStore.Services.Interfaces;
using SeaStore.ViewModels.Account;
...
namespace SeaStore.Controllers
{
  ...
  public class AccountController : Controller
  {
    ...
    private readonly SeaStoreDbContext _dbContext;
    ...
    private static void EnsureDatabaseCreated(SeaStoreDbContext context)
    {
      if (!_databaseChecked)
      {
